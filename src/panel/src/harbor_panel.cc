...
#include "../../include/harbor_logger.hh"
 ...
 */
    static void registry_global(void *data,
                                ...
                                uint32_t /* version */)
    {
        struct WaylandGlobals *globals = static_cast<struct WaylandGlobals *>(data);
        if (strcmp(interface, "wl_compositor") == 0)
        {
            globals->compositor = static_cast<struct wl_compositor *>(
                wl_registry_bind(registry, id, &wl_compositor_interface, 1));
        }
        else if (strcmp(interface, "wl_shell") == 0)
        {
            globals->shell = static_cast<struct wl_shell *>(
                wl_registry_bind(registry, id, &wl_shell_interface, 1));
        }
    }

    static const struct wl_registry_listener registry_listener = { registry_global, nullptr };
 ...
 */
    static void initWaylandDisplay(struct wl_display **wlDisplay, struct wl_surface **wlSurface)
    {
        ...
        *wlDisplay = wl_display_connect(nullptr);
        ...
        wl_registry_add_listener(registry, &registry_listener, static_cast<void *>(&globals));
        ...
        *wlSurface = wl_compositor_create_surface(globals.compositor);
        assert(*wlSurface != nullptr);

        struct wl_shell_surface *shellSurface =
            wl_shell_get_shell_surface(globals.shell, *wlSurface);
 ...
 * output eglSurface
 */
    static void initEGLDisplay(EGLNativeDisplayType nativeDisplay,
                               ...
                               EGLSurface *eglSurface)
    {
        ...
        *eglDisplay = eglGetDisplay(nativeDisplay);
        ...
        EGLBoolean initialized = eglInitialize(*eglDisplay, nullptr, nullptr);
        ...
        EGLContext eglContext =
            eglCreateContext(*eglDisplay, configs[0], EGL_NO_CONTEXT, context_attribs);

        *eglSurface = eglCreateWindowSurface(*eglDisplay, configs[0], nativeWindow, nullptr);
 ...
 * output eglSurface
 */
    static void initWindow(GLint width,
                           GLint height,
                           ...
                           EGLSurface *eglSurface)
    {
        ...
        initEGLDisplay(reinterpret_cast<EGLNativeDisplayType>(*wlDisplay),
                       reinterpret_cast<EGLNativeWindowType>(wlEglWindow), eglDisplay, eglSurface);
    }
 ...
 */
    ...
    {
        GLfloat vVertices[] = { 0.0f, 1.0f, 0.0f, -1.0f, -1.0f, 0.0f, 1.0f, -1.0f, 0.0f };
    ...
    static std::atomic_int keep_going{ true };
    ...
    void panel_quit() noexcept { keep_going = false; }
} // namespace harbor::panel
