...
private:
    ...
    friend std::uint8_t BCC(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t BCS(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t BEQ(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t BMI(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t BNE(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t BPL(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t BVC(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t BVS(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t BRK(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t CLC(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t CLD(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t CLI(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t CLV(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t DEX(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t DEY(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t INX(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t INY(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t JMP(Cpu6502 &, const State &) noexcept;
    ...
    friend std::uint8_t SEC(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t SED(Cpu6502 &, const State &) noexcept;
    friend std::uint8_t SEI(Cpu6502 &, const State &) noexcept;
