#ifndef PANEL_LOGGER_HH
#define PANEL_LOGGER_HH
...
#define LOG(...)                                                                                   \
    ...
    {                                                                                              \
        ...
        std::fprintf(stdout, FORMAT_STRING_INFO, year, month, day, hour, minute, second,           \
                     std::strrchr(__FILE__, PATH_SEPARATOR) + 1, __LINE__, __func__, LOG_BUFFER);  \
    } while (0)
