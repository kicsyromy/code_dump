...
// GRAPH1.C - This is the first module in the game library
...
for (index=0; index<=(unsigned int)y2-y1; index++)
    {
...
for (index=(unsigned int)(x1>>1)+1; index<(unsigned int)(x2>>1); index++)
